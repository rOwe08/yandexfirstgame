...
public class GuessManager : MonoBehaviour
{
    ...
    {
        { "Животные", new List<string> { "собака", "кот", "черепаха", "кролик", "хомяк", "лошадь", "ёж", "леопард", "ёлка" } },
        { "Еда", new List<string> { "яблоко", "банан", "пицца", "сосиска", "чипсы", "огурец", "пирожок", "блинчики" } },
        { "Аниме", new List<string> { "наруто", "блич", "ванпанчмен", "ван пис" } },
        { "Супергерои", new List<string> { "тор", "халк", "флеш", "супермен", "человек паук", "бэтмен" } },
        { "Игрушки", new List<string> { "лего", "барби", "робот", "спиннер" } },
        { "Школа", new List<string> { "учитель", "карандаш", "рюкзак", "ручка", "перемена" } },
        { "Цвета", new List<string> { "красный", "оранжевый", "желтый", "зелёный", "синий", "фиолетовый" } },
        { "Космос", new List<string> { "звезда", "планета", "галактика", "комета", "космонавт", "ракета", "созвездие", "метеорит" } },
        ...
        { "Природа", new List<string> { "цветок", "лес", "гора", "река", "пустыня", "вулкан", "море", "ураган", "снегирь", "зимородок", "ёмкость" } },
        { "Профессии", new List<string> { "метеоролог", "лётчик", "учитель", "пилот" } },
        { "Музыкальные инструменты", new List<string> { "балалайка", "аккордеон" } },
        { "Мебель", new List<string> { "кресло", "диван", "табуретка", "стол", "стул", "кровать" } },
        { "Школьные принадлежности", new List<string> { "линейка", "тетрадь", "пенал" } },
        { "Мифологические существа", new List<string> { "дракон", "единорог", "леший" } },
        { "Времена года", new List<string> { "весна", "лето", "осень", "зима" } },
        { "Растения", new List<string> { "одуванчик", "ромашка", "подсолнух" } },
        { "Фрукты и овощи", new List<string> { "апельсин", "томат", "огурец" } }
    };
