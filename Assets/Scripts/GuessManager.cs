...
public class GuessManager : MonoBehaviour
{
    ...
    {
        { "Животные", new List<string> { "собака", "кот", "черепаха", "кролик", "хомяк", "лошадь", "ёж", "леопард" } },
        { "Еда", new List<string> { "яблоко", "банан", "пицца", "сосиска", "чипсы", "огурец", "пирожок" } },
        ...
        { "Школа", new List<string> { "учитель", "карандаш", "рюкзак", "ручка", "перемена", "линейка", "тетрадь" } },
        ...
        { "Технологии", new List<string> { "ноутбук", "телефон", "планшет", "дрон", "интернет" } },
        ...
        { "Мебель", new List<string> { "кресло", "диван", "стол", "стул", "кровать" } },
